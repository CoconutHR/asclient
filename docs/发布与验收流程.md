...
6. 使用已验证提交创建与包版本一致的 Git tag，例如包版本 `0.9.1` 对应 `v0.9.1`。推送 tag 后，[Release workflow](../.github/workflows/release.yml) 会重新运行 Ubuntu/Windows、Python 3.10 至 3.13 验证，构建 wheel 与 sdist，生成 `SHA256SUMS`，并创建 GitHub Release。
